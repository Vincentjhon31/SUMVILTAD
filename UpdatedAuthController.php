...
{
    /**
     * Register a new user via API (matches your web registration)
     */
    public function register(Request $request)
    {
        ...
        // Create user with only the fields that exist in your database
        $user = User::create([
            'name' => $request->name,
            'email' => $request->email,
        ...
        // Create API token for immediate login (like your web version)
        try {
    ...
    public function login(Request $request)
    {
        ...
        // Simple login - no approval checks (matches your web app behavior)
        try {
